...
Write-Host "Running AI Sorter E2E Persistence Test in Microsoft Edge..." -ForegroundColor Cyan

$dataDir = [System.IO.Path]::Combine([System.IO.Path]::GetTempPath(), "edge-sorter-e2e-" + [System.Guid]::NewGuid().ToString("N"))
...
while ($waited -lt $timeout) {
    ...
    if (Test-Path $reportPath) {
        ...
        if ($raw -and $raw.Contains("E2E TEST RESULT")) {
