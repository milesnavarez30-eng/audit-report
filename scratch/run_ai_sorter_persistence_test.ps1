...
Write-Host "Running AI Sorter Persistence & Refresh Restoration Tests via Edge Headless..." -ForegroundColor Cyan

$dataDir = [System.IO.Path]::Combine([System.IO.Path]::GetTempPath(), "edge-sorter-test-" + [System.Guid]::NewGuid().ToString("N"))
