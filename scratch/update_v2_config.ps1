...
$tlJson = $lines[26551].Trim().Substring(23).TrimEnd(';')
$omJson = $lines[26552].Trim().Substring(23).TrimEnd(';')
$accJson = $lines[26553].Trim().Substring(28).TrimEnd(';')
...
Set-Content -Path 'c:\Users\Mnavares\Documents\CCTV OPS\audit-report\cctv-ops-v2\js\config.js' -Value $configContent -Encoding UTF8
Write-Output "Successfully updated cctv-ops-v2/js/config.js with authoritative data"
