...
$url = "http://localhost:8080/scratch/test_targeted_refinements.html"
...
Write-Host "Running Targeted Refinements Test in Microsoft Edge..." -ForegroundColor Cyan

$dataDir = [System.IO.Path]::Combine([System.IO.Path]::GetTempPath(), "edge-targeted-refine-" + [System.Guid]::NewGuid().ToString("N"))
